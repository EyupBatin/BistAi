...
class InterfaceAppBar extends StatefulWidget implements PreferredSizeWidget {
  InterfaceAppBar({super.key});

  @override
  _InterfaceAppBarState createState() => _InterfaceAppBarState();

  @override
  Size get preferredSize => const Size.fromHeight(kToolbarHeight);
}

class _InterfaceAppBarState extends State<InterfaceAppBar> {
